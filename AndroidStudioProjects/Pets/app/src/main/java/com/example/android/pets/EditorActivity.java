...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //if intent is from floating action button
        //in other words uri is empty
        if (mCurrentItemUri == null){
            setTitle(R.string.editor_activity_title_new_pet);//Add a Pet
            //invalidateOptionsMenu() is used to say Android, that contents of menu have changed, and menu should be redrawn.
            invalidateOptionsMenu();
        }else{
            setTitle(R.string.editor_activity_title_edit_pet);//Edit Pet
            //kick off the loader
            //error solution
    ...
    public void deletePet(){
        ...
        if (rowsDeleted == -1){
            Toast.makeText(this,R.string.pet_delete_failed,Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(this,R.string.pet_delete_successfully,Toast.LENGTH_SHORT).show();
        }
    }
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                ...
                !TextUtils.isEmpty(mWeightEditText.getText().toString())){
                    ...
                    Toast.makeText(this,"Enter missing values",Toast.LENGTH_SHORT).show();
                }
                return true;
            ...
            case R.id.action_delete:
                ...
                deletePet();
                finish();
                this.getContentResolver().notifyChange(PetContract.PetEntry.CONTENT_URI, null);
                return true;
    ...
    //loading data from uri into a cursor
    @Override
